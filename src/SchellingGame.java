...
public class SchellingGame {
    public static void main(String[] args) {
        ...
        SchellingGameEngine game = new SchellingGameEngine(gui, 30, 5, 2, 2);
    }
}
            ...
            for (int i = 0; i < grid.getSize(); i++) {
                for (int j = 0; j < grid.getSize(); j++) {
                    ...
                    if(emptyCells.contains(grid.getCell(i,j))) {
                        gui.addGraphicalElement(new Rectangle(i * this.cellWidth + 60, j * this.cellWidth + 60, Color.LIGHT_GRAY, colors[0], this.cellWidth));
                    }else{
